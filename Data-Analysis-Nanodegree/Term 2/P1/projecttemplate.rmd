...
```{r echo=FALSE, IncomeRange_revisions_to_IncomeRange2}
...
```{r echo=FALSE,  message=FALSE, warning=FALSE, check StatedMonthlyIncome.bucket}
...
the visualation does reveal that people with higher income are more likely to
...
The expected relationship between APR and homeownership doesn't seem to hold
true. Is there a relationship between homeownership and income range?
...
with homeownership and APR.


Despite it popping up in other visualizations, 
